...
# 01 - Claude Fable 5
F_FABLE_TOK = F_TOKEN + ' resource.label."model_user_id"=monitoring.regex.full_match("claude-(fable|opus)-.*")'
F_FABLE_INV = F_INVOC + ' resource.label."model_user_id"=monitoring.regex.full_match("claude-(fable|opus)-.*")'
F_FABLE_E2E = F_E2E + ' resource.label."model_user_id"=monitoring.regex.full_match("claude-(fable|opus)-.*")'
d01 = {
